...
#base = '/media/vip2data/malbert/registration/balinteger/64cells'
base = '/home/perigroup/research/Norlin/beads'
#base = '/home/malbert/mnt/hufdata3/malbert/erika/ZeissSpim/Fusion_27hpf_tFT/test'
#base = '/home/malbert/mnt/vip2data/malbert/nils'
#base = '/home/malbert/mnt/vip2data/malbert/nils'

config['filePattern'] = 'Time%(t)06d_00.tif' # time replaces %(t)pd, angle %(a)pd (p is the number of digits)

# bead files
#config['beads_LC'],config['beads_RC'] = [],[]
#config['beads_LC'].append(base+'/spimL/Nils/4b-tft_18hpf/beads/20140210_122847/Stack0000')
#config['beads_LC'].append(base+'/spimL/Nils/4b-tft_18hpf/beads/20140210_122847/Stack0001')
#config['beads_RC'].append(base+'/spimR/Nils/4b-tft_18hpf/beads/20140210_122847/Stack0000')
#config['beads_RC'].append(base+'/spimR/Nils/4b-tft_18hpf/beads/20140210_122847/Stack0001')

config['beads_LC'],config['beads_RC'] = [],[]
config['beads_LC'].append(base+'/view1')
#config['beads_LC'].append(base+'/LC/Beads/Stack0001')
config['beads_RC'].append(base+'/view2')
#config['beads_RC'].append(base+'/RC/Beads/Stack0001')

# timepoints
config['data_LC'],config['data_RC'] = [],[]
config['data_LC'].append(base+'/view1')
#config['data_LC'].append(base+'/LC/20120803/Stack0001')
config['data_RC'].append(base+'/view2')
#config['data_RC'].append(base+'/RC/20120803/Stack0001')


#config['data_LC'],config['data_RC'] = [],[]
#config['data_LC'].append(base+'/spimL/Nils/4b-tft_18hpf/20140207_193243/Stack0000')
#config['data_LC'].append(base+'/LC/20120803/Stack0001')
#config['data_RC'].append(base+'/spimR/Nils/4b-tft_18hpf/20140207_193243/Stack0000')
#config['data_RC'].append(base+'/RC/20120803/Stack0001')

# timepoints
#config['filePattern'] = 'Time%(t)06d_00.tif' # time replaces %(t)pd, angle %(a)pd (p is the number of digits)
#config['data_LC'],config['data_RC'] = [],[]
#config['data_LC'].append(base+'/LC/Stack0000/Time%(t)06d_00.tif')
#config['data_LC'].append(base+'/LC/Stack0001/Time%(t)06d_00.tif')
#config['data_RC'].append(base+'/RC/Stack0000/Time%(t)06d_00.tif')
#config['data_RC'].append(base+'/RC/Stack0001/Time%(t)06d_00.tif')
...
config['addData_LC'].append(base+'/LC/20120803/Stack0000')
config['addData_LC'].append(base+'/LC/20120803/Stack0001')
config['addData_RC'].append(base+'/RC/20120803/Stack0000')
config['addData_RC'].append(base+'/RC/20120803/Stack0001')
#########
# output
#########

#config['outDir'] = '/media/vip2data/malbert/registration/20120803/Data_scaled/Result6' # enough to set this variable to an empty folder
config['outDir'] = os.path.join('/home/malbert/Result')
#config['outDir'] = '/media/vip2data/malbert/erika/test_fish'
...
config['opposingFusionWithElastix']     = False  # ignore beads and perform image based registration for opposing views
                                                 # works only with onlyExecutePart = 1
...
config['parameterTemplateString'] = """
// Description: affine

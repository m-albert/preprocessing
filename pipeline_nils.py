...
if os.path.exists(beadParamsFile):
    ...
    segmentedBeads = [beads.segmentBeadsNils(
    ...
    for iview,view in enumerate(beadFiles):
        tmpParams = []
        tmpParams.append(list(beads.findParametersNils(segmentedBeads[iview])))
        tmpParams.append(list(beads.findParametersNils([segmentedBeads[0][0],segmentedBeads[iview][0]])))
